...
{ NODE_ENV, PORT, ASSET_PATH, APPLICATION_NAME, DEFAULT_CACHE_TIME, WORKS_NUM, ARTISTS_NUM, GALLERIES_NUM, IPHONE_APP_URL, CANONICAL_URL, FAIRS_NUM, MUSEUMS_NUM, PARTNER_HIGHLIGHT_COPY } = config = require "../config"
...
sharify.data =
  ...
  FAIRS_NUM: FAIRS_NUM
  MUSEUMS_NUM: MUSEUMS_NUM
  PARTNER_HIGHLIGHT_COPY: PARTNER_HIGHLIGHT_COPY
