...
module.exports = iPhoneView = (function(_super) {
  ...
  iPhoneView.prototype.phoneHeightToWidthRatio = 0.4733;
  ...
  iPhoneView.prototype.positionPhone = function() {
    ...
    this.width = this.height * this.phoneHeightToWidthRatio;
...
},{"backbone":15,"underscore":16}],6:[function(require,module,exports){
...
module.exports = HomePageView = (function(_super) {
  ...
  function HomePageView() {
    ...
    this.showNextImage = __bind(this.showNextImage, this);
  ...
  HomePageView.prototype.heroAnimationsActive = true;

  HomePageView.prototype.phoneContentAreaHeightRatio = 0.7053;

  HomePageView.prototype.phoneAreaAboveContentAreaToHeightRatio = 0.14759;
  ...
  HomePageView.prototype.initialize = function() {
    ...
    this.$mainPhoneContentAreas = this.$('#content .phone-content-area');
    ...
    return _.delay(function() {
      ...
      _this.initializePopLockit();
      _this.newAnimationFrame();
      return _this.initializeSections();
    }, 400);
  };

  HomePageView.prototype.initializePopLockit = function() {
    return $('#content').popLockIt({
  ...
  HomePageView.prototype.onResize = function() {
    var sectionName, sectionView, _ref1, _results;
    this.browserHeight = this.$window.height();
    this.sizeSections();
    this.documentHeight = this.$document.height();
    this.sizeHeaders();
    this.positionHeaders();
    this.sizeIphoneContentAreas();
    _ref1 = this.sectionViews;
    _results = [];
    for (sectionName in _ref1) {
      sectionView = _ref1[sectionName];
      _results.push(sectionView.onResize(this.browserHeight, this.documentHeight));
    }
    return _results;
  };
  ...
  HomePageView.prototype.sizeIphoneContentAreas = function() {
    ...
    this.$mainPhoneContentAreas.css({
      width: this.iphone.width
    });
  ...
  HomePageView.prototype.showNextImage = function() {
    var activeSplashImage,
      _this = this;
    if (!this.heroAnimationsActive) {
      return;
    }
    activeSplashImage = this.$('.splash-image.active').removeClass('active').next();
    return _.delay(function() {
      if (!_this.heroAnimationsActive) {
        return;
      }
  ...
  HomePageView.prototype.animateSplashImages = function() {
    return this.splashInterval = window.setInterval(this.showNextImage, 3000);
  };

  HomePageView.prototype.animate = function() {
    var direction, newScrollTop;
    newScrollTop = this.$window.scrollTop();
    if (newScrollTop !== this.scrollTop) {
      direction = newScrollTop > this.scrollTop ? 'down' : 'up';
      this.scrollTop = newScrollTop;
      if ((this.scrollTop > this.browserHeight - this.headerHeight) && (this.scrollTop < this.documentHeight - this.browserHeight - this.headerHeight)) {
        this.$header.addClass('white');
      } else {
        this.$header.removeClass('white');
      }
      if ((this.scrollTop > this.headerHeight) && (this.scrollTop < this.documentHeight - this.browserHeight - (this.headerHeight * 2))) {
        this.heroAnimationsActive = false;
      } else {
        this.heroAnimationsActive = true;
      }
    }
    return this.newAnimationFrame();
  };

  HomePageView.prototype.newAnimationFrame = function() {
...
},{"./browse_view.coffee":1,"./collect_view.coffee":2,"./explore_view.coffee":3,"./iphone_view.coffee":5,"./sms_view.coffee":7,"backbone":15,"underscore":16}],9:[function(require,module,exports){
var hash;
...
$(function() {
  var load, regexStr, _results;
  _results = [];
  for (regexStr in hash) {
    load = hash[regexStr];
...
},{"../../apps/home/client/index.coffee":4,"../../lib/jquery.js":12}],10:[function(require,module,exports){
var Backbone, analytics, popLockit, sd;
...
},{"../../lib/analytics.coffee":11,"../../lib/jquery.js":12,"../../lib/jquery.poplockit.coffee":13,"../../lib/shared_data.coffee":14,"backbone":15}],11:[function(require,module,exports){
var sd,
  _this = this;
...
module.exports = function(options) {
  var _ref;
  _this.mixpanel = options.mixpanel, _this.ga = options.ga, _this.location = options.location;
  if (_this.location == null) {
    _this.location = typeof window !== "undefined" && window !== null ? window.location : void 0;
  }
  if (typeof _this.ga === "function") {
    _this.ga('create', sd.GOOGLE_ANALYTICS_ID, 'artsy.net');
  }
  return (_ref = _this.mixpanel) != null ? _ref.init(sd.MIXPANEL_ID) : void 0;
};
...
module.exports.trackPageview = function() {
  ...
  return (_ref = _this.mixpanel) != null ? typeof _ref.track === "function" ? _ref.track('Viewed page', {
    path: _this.location.pathname
  }) : void 0 : void 0;
};


},{"./shared_data.coffee":14}],12:[function(require,module,exports){
/*!
