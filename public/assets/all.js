...
$.fn.removeColumnSpace = function() {
  return $(this).each(function(i, el) {
    return removeColumnSpaceFrom($(el));
  });
};

removeColumnSpaceFrom = module.exports = function($container) {
  var $imgs, setHeight;
  setHeight = function() {
    var height, lowestEl;
    lowestEl = _.last(_.sortBy($container.children(), function(el) {
