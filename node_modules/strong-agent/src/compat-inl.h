...
v8::Local<v8::Context> Debug::GetDebugContext(v8::Isolate* isolate) {
  struct Imp {
    static v8::Local<v8::Context> GetDebugContext(v8::Isolate* isolate) {
#if NODE_MAJOR_VERSION >= 6
      return v8::Debug::GetDebugContext(isolate);
#else
      I::Use(isolate);
      return v8::Debug::GetDebugContext();
#endif
    }
  };

  v8::Local<v8::Context> debug_context = Imp::GetDebugContext(isolate);
  ...
  if (debug_context.IsEmpty()) {
    ...
    debug_context = Imp::GetDebugContext(isolate);
  }
#endif
